//
// $Header: e:\\netlabs.cvs\\ext2fs/include/linux/ext2_fs.h,v 1.1 2001/05/09 17:43:37 umoeller Exp $
//
...
//
// This file is a OS/2 adaptation of /usr/src/linux-1.2.1/include/linux/ext2_fs.h
// It contains the ext2 disk layout structure definitions
// OS/2 adaptation - copyright (C) Matthieu WILLM 1995
//
 ...
 */
     ...
     */
        ...
        #define ext2_debug(f, a...)      { \
            ...
            void INLINE ext2_debug(const char *f, ...) {}
        #else
            #define ext2_debug(f, a...) /**/
        #endif
    #endif
    ...
    #ifdef OS2
        #define INODE_DASD          0xFFFFFFFF  /* direct access 'inode'    */
    #endif
...
// moved this part up V0.9.12 (2001-04-29) [umoeller]
    /*
...
// end V0.9.12 (2001-04-29) [umoeller]
    ...
    #define EXT2_DIR_REC_LEN(name_len)      (((name_len) + 8 + EXT2_DIR_ROUND) & \
                                             ~EXT2_DIR_ROUND)
    #else
    #define EXT2_DIR_PAD                    4U
    #define EXT2_DIR_ROUND                  (EXT2_DIR_PAD - 1U)
    #define EXT2_DIR_REC_LEN(name_len)      (((name_len) + 8U + EXT2_DIR_ROUND) & \
                                             ~EXT2_DIR_ROUND)
    #endif
