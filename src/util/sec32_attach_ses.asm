;
; $Header: e:\\netlabs.cvs\\ext2fs/src/util/sec32_attach_ses.asm,v 1.1 2001/05/09 17:49:52 umoeller Exp $
;
...
CODE32 segment
ASSUME CS:CODE32, DS:FLAT, ES:FLAT
...
thunk32$sec32_attach_ses_1 label far:
        mov ecx, es
        mov ds, ecx
        jc short @@error
...
thunk32$sec32_attach_ses_2 label far:
        add esp, 4
