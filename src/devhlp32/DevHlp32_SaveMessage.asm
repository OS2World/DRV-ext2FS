...
;
;       int DH32ENTRY DevHlp32_SaveMessage(char *msg,         /* ebp + 8  */
;                                          int   len          /* ebp + 12 */
;                                         );
;
...
;                                         );
;
;       WARNING: This code allocates GDT selectors and
;       DOES NOT run at init time on ring 3 (at least
;       in IFS drivers, from my testing).
;
; --------------------------------------------------
...
thunk32$DevHlp32_SaveMessage_1 label far:
        jc @@error
...
thunk32$DevHlp32_SaveMessage_2 label far:
        mov [ebp - 10], ax                       ; rc
        jc short @@error_2
...
thunk32$DevHlp32_SaveMessage_3 label far:
        jc @@error_2
        mov [ebp - 10], ax                       ; rc
...
thunk32$DevHlp32_SaveMessage_4 label far:
        jc @@error
