;
; $Header: e:\\netlabs.cvs\\ext2fs/src/fsh32/fsh32_dovolio.asm,v 1.1 2001/05/09 17:51:19 umoeller Exp $
;
...
thunk32$fsh32_dovolio_1 label far:
        jc @@error
...
thunk32$fsh32_dovolio_2 label far:
        mov [ebp - 6], ax                       ; rc
        jc short @@error_2
...
thunk32$fsh32_dovolio_3 label far:
        mov [ebp - 6], ax                       ; rc
...
thunk32$fsh32_dovolio_4 label far:
        jc @@error
